        ...
        <div className='py-[120px]'>
            <Marquee autoFill={true} speed={30}>
                <div className='flex flex-col gap-6'>
                    ...
                    <Image src="https://shorturl.at/lKQZ1" alt="" width={500} height={500} />
                    <Image src="https://shorturl.at/aikPQ" alt="" width={500} height={500} />
                    <Image src="https://shorturl.at/hCDEL" alt="" width={500} height={500} />
                </div>
                <div className=' mx-6 flex flex-col gap-6'>

                    <Image src="https://shorturl.at/cewVX" alt="" width={500} height={500} />
            ...
            <div className='bg-black'>
                ...
                <Marquee pauseOnHover={true} speed={80}>
                    <div className='text-white p-6 italic flex gap-10'>
                        <p>
                            "I hate every minute of training. But I said, don’t quit. Suffer now and live the rest of your life as a champion.” — Mohamm1ad Ali
